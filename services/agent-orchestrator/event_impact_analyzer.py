...
## Rules
- Return at least 5 and at most 15 impacted assets
...
async def simulate_single_asset(
    ...
    # Seed the book with initial liquidity around base_price
    _seed_book(book, base_price, initial_spread, n_levels=5)
    ...
    for tick in range(1, n_ticks + 1):
        ...
        # Replenish liquidity (market makers continuously provide quotes)
        _seed_book(book, book.mid_price, current_spread, n_levels=3)
...
def _seed_book(
    ...
    for i in range(n_levels):
        ...
        qty = random.randint(5, 20) * (n_levels - i)  # more liquidity near mid
